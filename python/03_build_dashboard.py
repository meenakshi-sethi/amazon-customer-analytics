...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .chooser{border:1px solid var(--rule);background:#faf6ee;padding:0;margin:22px 0}
  .chooser summary{cursor:pointer;list-style:none;padding:14px 22px;font-family:'Playfair Display',Georgia,serif;
    font-size:19px;font-weight:700;position:relative}
  .chooser summary::-webkit-details-marker{display:none}
  .chooser summary::after{content:'+';position:absolute;right:22px;top:50%;transform:translateY(-50%);
    font-family:'Helvetica Neue',Arial,sans-serif;font-size:20px;font-weight:400;color:var(--muted)}
  .chooser details[open] summary::after,.chooser[open] summary::after{content:'\2212'}
  .chooser summary:hover{background:#f3ecdd}
  .chooser .chooserbody{padding:6px 22px 20px}
  ...
  a.taxchip{text-decoration:none;color:inherit;cursor:pointer;transition:background .15s,transform .15s}
  a.taxchip:hover{background:var(--ink);color:#faf6ee}
  a.taxchip:hover .q{color:inherit}
  html{scroll-behavior:smooth}
...
<div class="sheet">
  ...
  <section class="chap" id="c5">
    ...
    <div class="taxstrip">
      ...
      <a class="taxchip used tip" href="#c2" data-tip="<b>Exploratory data analysis (EDA).</b> Look before you leap &mdash; plots and summaries to find patterns before any hypothesis is fixed. Takes you to Chapter II, the segmentation.">Exploratory<span class="q">what's in there?</span></a>
      ...
      <a class="taxchip used tip" href="#c5" data-tip="<b>Inferential analysis.</b> Does the pattern hold beyond this sample? Hypothesis tests, p-values, effect sizes. You are here &mdash; every verdict card below.">Inferential<span class="q">does it hold up?</span></a>
    </div>
    <p class="body" style="font-size:12px;color:var(--muted);margin:6px 0 0">Each chip is the kind of analysis this report performs &mdash; click one to jump to where it happens; hover to learn what it's for.</p>
    ...
    <details class="chooser">
      <summary>Which tool, when? &mdash; the analyst's chooser</summary>
      <div class="chooserbody">
