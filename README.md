...
└── exports/                    ← (gitignored; regenerated by the pipeline)
```

The 356 MB raw database and the 37 MB review-level export are **gitignored** — the repo stays lean, and anyone can regenerate every number from the Kaggle source with the commands above.
